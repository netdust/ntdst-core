 ...
 * (`admin_u_i`) and the F7 call-order fix are recorded once, in
 * `.superpowers/sdd/plan/core-trim/migration-notes.md`. A migration log inside
 * a class docblock is read by nobody upgrading and by everybody maintaining.
 */
